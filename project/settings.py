...
Generated by 'django-admin startproject' using Django 5.docker-compose.yml.5.
...
SECRET_KEY = 'django-insecure-hhfdry(w10pb^6m)7(m4ddoe*l7^docker-compose.yml)ow@h)rstw_&t%ksyy+fk'
